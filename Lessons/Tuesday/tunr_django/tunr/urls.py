...
urlpatterns = [
    ...
    path('artist/<int:pk', views.artist_delete, name='artist_delete'),
    path('song/<int:id', views.song_delete, name='song_delete'),
    ...
    path('api/songs/<int:id>', views.SongDetail.as_view(), name='song-detail'),
]